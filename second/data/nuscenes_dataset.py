...
class NuScenesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        example["lidar_points"] = input_dict["lidar"]["points"]
        example["gt_boxes_lidar"] = input_dict["lidar"]["annotations"]["boxes"]
        example["gt_boxes_names"] = input_dict["lidar"]["annotations"]["names"]

        # lidar_points = example["lidar_points"]
        # gt_boxes_lidar = example["gt_boxes_lidar"]
        # masks = box_np_ops.points_in_rbbox(lidar_points, gt_boxes_lidar)
        # points_in_bboxes = lidar_points[masks.any(-1)]
        # print('lidar_points: ', lidar_points)
        # print('gt_boxes_lidar: ', gt_boxes_lidar)
        # print('points_in_bboxes: ', points_in_bboxes)
...
def create_nuscenes_infos(root_path, version="v1.0-trainval", max_sweeps=10):
    ...
    if version == "v1.0-trainval":
        ...
        val_scenes = list(sorted(set(splits.train + splits.val)))
