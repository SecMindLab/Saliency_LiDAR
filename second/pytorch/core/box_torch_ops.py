...
from second.core.non_max_suppression.nms_gpu import (nms_gpu_cc, nms_gpu, rotate_iou_gpu,
                                                       rotate_nms_gpu)
...
def nms(bboxes,
    ...
    if len(dets_np) == 0:
        ...
        # ret = np.array(nms_gpu_cc(dets_np, iou_threshold), dtype=np.int64) # might cause segmentation fault(core dump)
