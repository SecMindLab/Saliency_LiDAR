...
class VoxelNet(nn.Module):
    ...
    def network_forward(self, voxels, num_points, coors, batch_size):
        ...
        # note that all variables are with gradients
        """
        self.start_timer("voxel_feature_extractor")
        voxel_features = self.voxel_feature_extractor(voxels, num_points,
                                                      coors)
        # print('voxel_features in network_forward: ', voxel_features) # with gradients
    ...
    def forward(self, example):
        ...
        # coors: [num_voxels, 4]
        # print('voxels in forward: ', voxels)
        # print('num_points in forward: ', num_points)
        # print('coors in forward: ', coors)
        preds_dict = self.network_forward(voxels, num_points, coors, batch_size_dev)
        # print('preds_dict in forward: ', preds_dict) # with gradients
        # need to check size.
